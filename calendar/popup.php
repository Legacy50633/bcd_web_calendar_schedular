...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['id'])){
        ...
        $sql = "SELECT `id`,`event_id`,`message`, `startdate`, `enddate`, `notallowed`, `timing`, `colour`,`audioname`,`audio`,`bellid`,`paulid`,`adhikaramid`,`thirukkuralid` FROM `taskmanager` WHERE id = $eventid";
